...
try:
    ...
    wandb = None  # only required when --use_wandb is set
import argparse
import numpy as np
import pandas as pd
...
if __name__ == '__main__':
    ...
    parser.add_argument('--film', type=str, default='context', choices=['none', 'context', 'meta'],
                        help="FiLM ablation: none=upstream baseline (no adaLN modulation), "
                             "context=adaLN on img+time every layer, meta=context+metadata embedding")

...
best result. Two negative results sharpen the recipe: categorical organ identity does not help
(unseen organs fall back to a null token), and a morphology mixture-of-experts overfits the small
folds. Finally, we show that near-zero transfer scores on three organs are a \emph{metric

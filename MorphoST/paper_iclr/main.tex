...
\medskip
\subsection{Results for RQ1: Predictive performance across diverse organs}
\label{sec:rq1}
...
full seven-organ HEST panel (BLEEP $0.758$); BLEEP obtains the lowest absolute error. Thus one shared
model serves many organs at once, without per-organ retraining, provided each organ is represented
during training.
...
\FloatBarrier
\medskip
\subsection{Results for RQ2: Cross-organ transfer to an unseen organ}
\label{sec:transfer}

...
to interpret; a \emph{paired per-slide} comparison, however, is decisive: \morph{} beats BLEEP on
$78\%$ of slides for ARI and $90\%$ for NMI ($n{=}58$ held-out slides; Wilcoxon $p<0.001$ for both).
...
($n{=}58$; Wilcoxon $p<0.001$), though the absolute domain agreement remains modest.
\end{keybox}

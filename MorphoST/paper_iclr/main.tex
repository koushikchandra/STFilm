...
neighbours. The complete model (L+G+S) is best; local attention is the dominant stream.}
\label{tab:ablation}
\small
...
\midrule
Full \morph{}            & L\,+\,G\,+\,S & \best{$0.605_{0.006}$} \\
Global\,+\,Local         & L\,+\,G       & $0.596_{0.007}$ \\
Global\,+\,Slide         & G\,+\,S       & $0.570_{0.037}$ \\
Global only              & G             & $0.590_{0.005}$ \\
Local\,+\,Slide          & L\,+\,S       & $0.601_{0.007}$ \\
Local only               & L             & $0.597_{0.021}$ \\
Slide only               & S             & $0.580_{0.020}$ \\
\midrule
Global\,+\,Local (random nbr.) & L$_{\text{rand}}$\,+\,G & $0.584_{0.011}$ \\
Full, random nbr.        & L$_{\text{rand}}$\,+\,G\,+\,S & \textcolor{gray}{\textit{running}} \\
\bottomrule
\end{tabular}
\end{table}

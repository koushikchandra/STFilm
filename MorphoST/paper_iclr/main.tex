...
In intra-cohort prediction of 100 genes, \morph{} improves mean Pearson correlation by $11.4\%$ over
the strongest baseline and leads on all six cohorts. In pooled evaluation on held-out samples from represented organs, it improves

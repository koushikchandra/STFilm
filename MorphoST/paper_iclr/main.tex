...
\textbf{RQ4 (Structure):} How well do the predicted expression profiles preserve spatial domains identified from measured expression?
...
\noindent\textbf{H\&E to ST prediction.}\quad Prior models span patch-level regression
...
$0.599$ on the six-organ HEST panel (BLEEP $0.587$). Together, these two settings answer RQ1:
...
Table~\ref{tab:looo_6organ}). On the six-organ HEST panel \morph{} reaches $0.422$ versus
...
\begin{table}[H]
\centering
\caption{\textbf{HEST-1k cohort statistics.} Spots after barcode filtering; folds = per-cohort train/test splits. The six \checkmark\ cohorts form the no-COAD cross-organ set; HCC, LYMPH\_IDC, and READ are excluded.}

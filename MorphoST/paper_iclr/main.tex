...
\medskip
\noindent We investigate four questions: \textbf{RQ1 (Performance)} accuracy across diverse organs, both per-organ and with a single pooled model; \textbf{RQ2 (Transfer)} generalization to an entirely unseen organ under LOOO; \textbf{RQ3 (Design)} the effect of encoder, context streams, and neighborhood definition; and \textbf{RQ4 (Structure)} spatial-domain recovery.

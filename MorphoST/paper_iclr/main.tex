...
\midrule
Full \morph{}            & L\,+\,G\,+\,S & \best{$0.61_{0.01}$} & \best{$0.42_{0.01}$} & \best{$0.40_{0.01}$} \\
Global\,+\,Local         & L\,+\,G       & $0.60_{0.01}$ & $0.46_{0.02}$ & $0.41_{0.01}$ \\
Global\,+\,Slide         & G\,+\,S       & $0.57_{0.04}$ & $0.52_{0.13}$ & $0.44_{0.05}$ \\
Global only              & G             & $0.59_{0.00}$ & $0.47_{0.02}$ & $0.42_{0.01}$ \\
Local\,+\,Slide          & L\,+\,S       & $0.60_{0.01}$ & $0.43_{0.03}$ & $0.40_{0.02}$ \\
Local only               & L             & $0.60_{0.02}$ & $0.46_{0.05}$ & $0.41_{0.02}$ \\
Slide only               & S             & $0.58_{0.02}$ & $0.47_{0.03}$ & $0.42_{0.02}$ \\
\midrule
Global\,+\,Local (random nbr.) & L$_{\text{rand}}$\,+\,G & $0.58_{0.01}$ & $0.45_{0.01}$ & $0.40_{0.00}$ \\
Full, random nbr.        & L$_{\text{rand}}$\,+\,G\,+\,S & $0.58_{0.01}$ & $0.47_{0.01}$ & $0.41_{0.00}$ \\
\bottomrule
\end{tabular}}
\end{table}
